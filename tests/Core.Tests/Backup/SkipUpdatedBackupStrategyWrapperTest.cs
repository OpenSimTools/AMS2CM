...
public class SkipUpdatedBackupStrategyWrapperTest
{
    ...
    public void PerformBackup_ProxiesCallToInnerStategy()
    {
        ...
        var subs = new SkipUpdatedBackupStrategyWrapper(fs, innerStategyMock.Object, null);
    ...
    {
        var fs = new MockFileSystem(new Dictionary<string, MockFileData>());
        var subs = new SkipUpdatedBackupStrategyWrapper(fs, innerStategyMock.Object, DateTime.UtcNow);
    ...
    public void RestoreBackup_DeletesBackupIfOverwritten()
    {
        ...
        var subs = new SkipUpdatedBackupStrategyWrapper(fs, innerStategyMock.Object, backupTime);
