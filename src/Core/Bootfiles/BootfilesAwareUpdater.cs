...
public class BootfilesAwareUpdater : IInstallationsUpdater
{
    private readonly IInstallationsUpdater inner;

    private readonly IGame game;
    private readonly ITempDir tempDir;
    private readonly BaseInstaller.IConfig installerConfig;

    public BootfilesAwareUpdater(IInstallationsUpdater inner, IGame game, ITempDir tempDir, BaseInstaller.IConfig installerConfig)
    {
        this.inner = inner;
        this.game = game;
    ...
    private BootfilesInstaller CreateBootfilesInstaller(IEnumerable<IInstaller> bootfilesPackageInstallers, InstallationsUpdater.IEventHandler eventHandler)
    {
